...
namespace keyout
{
	public static class Extern {
		...
		public delegate IntPtr LowLevelKeyboardProc(int nCode, IntPtr wParam, ref KBDLLHOOKSTRUCT kbd);
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto, SetLastError = true)]
		public static extern IntPtr CallNextHookEx(IntPtr hhk, int nCode, IntPtr wParam, ref KBDLLHOOKSTRUCT kbd);
		...
		public enum MapVirtualKeyMapTypes : uint
		{
		     ...
		     /// <summary>
		     /// uCode is a scan code and is translated into a
		     ...
		     /// If it is a virtual-key code that does not distinguish between left- and
		     /// right-hand keys, the left-hand scan code is returned.
		     /// If the scan code is an extended scan code, the high byte of the uCode value
